...
function init() {
    ...
    myDiagram.addDiagramListener("ChangedSelection", function(e1) {
        ...
        if (txtblock.link) {
            str += '<p><a  href="javascript:highlightSearch(\'' + txtblock.link + '\')"><strong>Attacment</strong></a></p>';
        };
...
function highlightSearch(text) {
    ...
    var e = document.getElementById("wiki-div").innerHTML;
    var enew = e.replace(/(<span>|<\/span>)/igm, "");
    document.getElementById("wiki-div").innerHTML = enew;
    var newe = enew.replace(query, "<span class='searched'>$1</span>");
    setTimeout(
    function() {
      $.scrollTo('.searched');//scroll to target
    }, 300);
    document.getElementById("wiki-div").innerHTML = newe;
