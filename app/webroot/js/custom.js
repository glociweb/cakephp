    ...
    $('#fileupload').fileupload({
            ...
            dataType: 'json',
                ...
                $.each(data.result.files, function(index, file) {
                    ...
                    var file = "<a target='_blank' href='" + url + "'>" + file.name + "</a>"
...
function initPicker() {
    var picker = new FilePicker({
        ...
        onSelect: function(file) {
            ...
            var file = "<a target='_blank' href='" + file.alternateLink + "'>" + file.title + "</a>"
            $('#attachments').append(file);
        }
    });
}
...
function noteAttachdb() {
    var options = {
        ...
        success: function(files) {
            ...
            var file = "<a target='_blank' href='" + files[0].link + "'>" + files[0].name + "</a>"
            $('#attachments').append(file);
        },
        cancel: function() {
