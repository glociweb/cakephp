    ...
    r(l, [], function() {
                    ...
                    if (d < c.index && l.text(z(e.substr(d, c.index - d))), u = c[6]) u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), i(u);
                        ...
                        if (u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), w = u in C, W && M[u] && p.length > 0 && p[p.length - 1].name === u && i(u), !_ || (E = a.getElementRule(u))) {
                            if (N = !0, _ && (T = E.attributes, R = E.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (N = !1), m = [], m.map = {}, S.replace(P, s)) : (m = [], m.map = {}), _ && !y) {
                                if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, L = E.removeEmptyAttrs, L && !m.length && (N = !1), D)
                                    for (h = D.length; h--;) k = D[h], v = k.name, I = k.value, "{$uid}" === I && (I = "mce_" + F++), m.map[v] = I, m.push({
                                        name: v,
                                        value: I
                                    });
                                if (B)
                                    for (h = B.length; h--;) k = B[h], v = k.name, v in m.map || (I = k.value, "{$uid}" === I && (I = "mce_" + F++), m.map[v] = I, m.push({
                                        name: v,
                                        value: I
                                    }));
                                if (A) {
        ...
        return function(a) {
            ...
            function g(t, n, r) {
                ...
                if (p)
                    if (r) r.nodeType ? (v = W.createRng(), v.setStartBefore(r), v.setEndAfter(r), d(D(v, u), null, !0)) : d(r, null, !0);
            ...
            function v(e, t, n) {
                function r(e) {
                    var n, i, o, a, s;
                    if (1 === e.nodeType && et(e) && (a = v, v = "true" === et(e), s = !0), n = ot(e.childNodes), v && !s)
                        for (i = 0, o = u.length; o > i && !L(u[i], t, e, e); i++);
                    if (p.deep && n.length) {
                ...
                function o(e, n, r, i) {
                    ...
                    if (e) {
                        for (d = e.parentNode, o = n.parentNode; o && o != d; o = o.parentNode) {
                            for (a = W.clone(o, X), c = 0; c < u.length; c++)
                                if (L(u[c], t, a, a)) {
                                    a = 0;
                                    break
                                }
            ...
            function I(t, n, r) {
                ...
                function p() {
                    ...
                    if (d)
                        if (l) a = V.getBookmark(), e.collapse(!0), e = D(e, f(n), !0), e = U.split(e), v(n, r, e), V.moveToBookmark(a);
                        else {
            ...
            function F(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = K(n), n = n.parentNode, i = !0), 1 == n.nodeType)
                    for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, W.getParent(n, W.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())
                        if (3 == a.nodeType && !A(a)) return l = W.create("a", null, Y), a.parentNode.insertBefore(l, a), t.setStart(a, 0), V.setRng(t), void W.remove(l)
            }
            var z = {},
                W = a.dom,
                V = a.selection,
        ...
        return function(r) {
            ...
            a(this, {
                ...
                mceInsertContent: function(t, n, a) {
                    ...
                    function l(e) {
                        if (w)
                            for (b = e.firstChild; b; b = b.walk(!0)) N[b.name] && b.attr("data-mce-new", "true")
                    }
                    ...
                    if (h = d.parse(a, T), l(h), b = h.lastChild, "mce_marker" == b.attr("id"))
        ...
        function t(e) {
            ...
            function i(e, n, r) {
                var i, o, a;
                if (n === !1 && (n = t), n)
                    for (o = e.toLowerCase().split(" "), a = o.length; a--;) e = o[a], i = c[e], i || (i = c[e] = [], d(e, !0)), r ? i.unshift(n) : i.push(n);
                return s
            }
            ...
            function o(e, t) {
                ...
                if (e)
                    for (o = e.toLowerCase().split(" "), n = o.length; n--;) {
                        ...
                        if (r) {
                            if (t)
                                for (a = r.length; a--;) r[a] === t && r.splice(a, 1);
                            else r.length = 0;
        ...
        return e.extend({
            recalc: function(e) {
                ...
                for (f = 0; n > f; f++)
                    for (u = 0; r > u && (d = i[f * r + u], d); u++) c = d.layoutRect(), k = c.minW, S = c.minH, E[u] = k > E[u] ? k : E[u], N[f] = S > N[f] ? S : N[f];
