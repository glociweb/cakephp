...
class AppVersion
{
    ...
    const Version = \'' . $this->NewVersion . '\';
            ...
            $this->Session->setFlash(__('You have successfully updated the ClientEngage Project Platform to v') . $this->NewVersion, Flash::Success);
            $this->redirect(array('controller' => 'users', 'action' => 'login', 'admin' => true, 'plugin' => null));
        }
    }
    ...
    private function __getNewMigrations()
    {
        ...
        {
            $version = class_exists('AppVersion') ? AppVersion::Version : (defined('AppLib::Version') ? AppLib::Version : '1.0.1'); // For v < 1.1.0
