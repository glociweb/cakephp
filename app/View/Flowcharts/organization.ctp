               ...
               <div class="panel-body">
                  <div id="all-flowchart" class="">
                     ...
                     <div class="col-lg-12 flowcharts <?php echo $count==1? 'active':'' ?>">
                        ...
                        <?php echo $chart['OrgCharts']['chart_name']; ?>
                        </a>
                     </div>
                     <?php
                        $count++;
         ...
         <div  class="panel panel-default " >
            ...
            <div class="buttons panel-body">
				<div class="form-group">
                  <input type="text" readonly class="Flowcharts_chart_name form-control" id="flowchartname" name="flowchartname" value="<?php echo  !empty($flowcharts) ? $flowcharts[0]['OrgCharts']['chart_name']: '' ; ?>">
      ...
      <div class="content">
         ...
         <span class="chart-outer">
            ...
            <div id="charts" class="tab-pane fade in active">
               <div id="myDiagram" style="overflow:hidden;border: solid 1px #e2e2e2; min-height: 720px">
                  <i class="fa fa-arrows-alt link"></i>
               </div>
               <textarea style="display:none" id="mySavedModel" style="width:100%;height:300px">
				  <?php echo  !empty($flowcharts) ?$flowcharts[0]['OrgCharts']['chart_json']: '' ; ?>
		</textarea>
         </span>
         </div>
         <div id="wiki" class="tab-pane fade">
            <div id="wiki-div" style="padding:5px;border: solid 1px #e2e2e2;overflow:hidden; height: 720px">
               <?php echo  !empty($flowcharts) ?$flowcharts[0]['OrgCharts']['chart_wiki']: '' ; ?>
            </div>
         </div>
      </div>
   </div>
