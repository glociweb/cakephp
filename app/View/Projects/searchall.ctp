...
<ul class="search-list" style="max-height: 350px;overflow-y: scroll;">
    ...
    <?php if (!empty($results['Project'])): ?>
        ...
        <?php endforeach; ?>
        <?php echo  count($results['Project']) == $limit? "<a class='viewall' alt='Project'>view all</a>" :''; ?>
        </div>
    <?php endif; ?>
    <!-- project emd -->
    ...
    <div class="search-outer">
        ...
        <?php endforeach; ?>
        <?php echo  count($results['Phase']) == $limit? "<a class='viewall' alt='Phase'>view all</a>" :''; ?>
        </div>
    <?php endif; ?>
    <!-- end phase -->
    ...
    <div class="search-outer">
        ...
        <?php endforeach; ?>
        <?php echo  count($results['Comment']) == $limit? "<a class='viewall' alt='Comment'>view all</a>" :''; ?>
        <div>
    <?php endif; ?>
    <!-- Comment end -->
    ...
    <div class="search-outer">
        ...
        <?php endforeach; ?>
        <?php echo  count($results['Notes']) == $limit? "<a class='viewall' alt='Notes'>view all</a>" :''; ?>
         </div>
    <?php endif; ?>
    <!-- notes end -->
    ...
    <?php if (!empty($results['Notescomment'])): ?>
        ...
        <?php endforeach; ?>
			<?php echo  count($results['Notescomment']) == $limit? "<a class='viewall' alt='Notescomment'>view all</a>" :''; ?>
			 </div>
    <?php endif; ?>
    <!-- notesComment end -->
