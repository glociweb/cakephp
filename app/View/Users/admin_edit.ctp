...
<div class="users form">
    ...
    <fieldset>
        ...
        echo $this->Form->input('client_id', array('label' => 'Client', 'options' => array(__('- Please select -'), __('Available Clients') => $clients), 'type' => 'select'));
        echo $this->Form->input('department', array('label' => 'Department', 'options' => array(__('- Please select -'), __('Available Clients') => $departments), 'type' => 'select'));
    ...
    <div class="form-actions">
        ...
        <?php echo $this->Html->link('<i class="ico-cancel"></i> ' . __('Cancel'), array('action' => 'view', $this->Form->value('User.id')), array('escape' => false, 'class' => 'btn')); ?>
    </div>    
...
<div class="actions">
    ...
    <div class="btn-toolbar">
        <div class="btn-group">
            <?php echo $this->Html->link('<i class="ico-folder_go"></i> ' . __('View User'), array('action' => 'view', $this->Form->value('User.id')), array('escape' => false, 'class' => 'btn')); ?>	
            <?php echo $this->Form->postLink('<i class="ico-bin_closed"></i> ' . __('Delete'), array('action' => 'delete', $this->Form->value('User.id')), array('escape' => false, 'class' => 'btn btn-danger'), __('Are you sure you want to delete %s?', $this->Form->value('User.username'))); ?>		
