            ...
            <div class="panel-body">
               <div id="all-flowchart" class="">
                  ...
                  <div class="col-lg-12 flowcharts">
                     ...
                     <?php echo $chart['Charts']['chart_name']; ?></a>
                     <i onclick="deletechart('<?php echo $chart['Charts']['id']; ?>',this)" class="fa fa-times-circle-o link deletechart"></i>
                  </div>
                  <?php
                     } ?>
                  <!-- /.col-lg-8 (nested) -->
   ...
   <div class="sidebar right">
      <div  class="panel panel-default " >
         ...
         <div class="buttons panel-body">
            ...
            <button class="savebtn btn btn-primary" id="SaveButton" onclick="save('')">Save</button>
			...
			<button id="sharebutton" style="padding: 6px 9px;" onclick="sharechart()" type="button" class="savebtn btn btn-primary" data-toggle="modal" data-target="#myModal">
				  Share
				</button>
         </div>
