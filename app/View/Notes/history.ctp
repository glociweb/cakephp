        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            foreach ($Noteshistory as $notes):
                ...
                <tr>
                    ...
                    <td><?php echo $this->Html->link($notes['Noteshistory']['title'], array('controller' => 'notes','action' => 'viewhistory', $notes['Noteshistory']['id'],$notes['Noteshistory']['version'], 'admin' => false)); ?></td>
