...
<div class="actions">
   ...
   <div class="btn-toolbar">
      <div class="btn-group">		
         <?php echo $this->Html->link('<i class="ico-table"></i> ' . __('Back to Project Overview'), array('controller'=>'projects','action' => 'dashboard', $project['Project']['slug']), array('escape' => false, 'class' => 'btn')); ?> 
      </div>
   </div>
</div>
