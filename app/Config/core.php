...
define('projecturl','http://192.168.1.31/Eb/');
/**
 * Configure Session
 */
 ...
 */
if (file_exists(APP . 'Config' . DS . 'version.php'))
...
/**
 * Configure project caching
 */
Cache::config(AppCaches::Project, array(
    'engine' => $cacheEngine,
    'prefix' => $cachePrefix . 'app_project_',
...
/**
 * Contains cache-configuration keys
 */
final class AppCaches
{
    // Cache-configuration key for project caching
